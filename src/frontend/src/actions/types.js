...
// Chat types
export const SEARCH_WORKSPACES_REQUEST = 'SEARCH_WORKSPACES_REQUEST';
export const SEARCH_WORKSPACES_FAILED = 'SEARCH_WORKSPACES_FAILED';
export const SEARCH_WORKSPACES_SUCCESS = 'SEARCH_WORKSPACES_SUCCESS';
export const JOIN_WORKSPACE_REQUEST = 'JOIN_WORKSPACE_REQUEST';
export const JOIN_WORKSPACE_SUCCESS = 'JOIN_WORKSPACE_SUCCESS';
export const JOIN_WORKSPACE_FAILED = 'JOIN_WORKSPACE_FAILED';
...
export const ROOM_ACCESS_GRANTED = 'ROOM_ACCESS_GRANTED';
export const ROOM_ACCESS_DENIED = 'ROOM_ACCESS_DENIED';
export const ROOM_CHECK_PASSWORD = 'ROOM_CHECK_PASSWORD';
export const ROOM_PASSWORD_CORRECT = 'ROOM_PASSWORD_CORRECT';
export const ROOM_PASSWORD_INCORRECT = 'ROOM_PASSWORD_INCORRECT';
